                                ...
                                @foreach($products as $product)
                                    <div class="col-6 col-md-4 col-lg-4">
                                        <div class="product product-11 text-center" >
                                            ...
                                            <a href="product.html">
                                                <img src="{{asset($product->image)}}" alt="Product image" class="product-image" style="height: 220px;padding:10px;background-color:#FFFFFF">
                                            </a>
                                            ...
                                            <div class="product-body">
                                                <div class="product-cat">
                                                    <a href="#" id="name">{{$product->category->name}}</a>
                                                </div><!-- End .product-cat -->
